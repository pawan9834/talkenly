...
// WhatsApp style Contact Item
const ContactItem = React.memo(({ item, colors, onPress, onInvite }: {
  item: LocalContact;
  colors: any;
  ...
  return (
    <TouchableOpacity
      ...
      activeOpacity={0.7}
      onPress={() => isRegistered ? onPress(item) : (onInvite ? onInvite(item) : null)}
    >
...
export default function ContactsScreen() {
  ...
  ].filter(section => section.data.length > 0), [registeredContacts, inviteContacts]);
      ...
      <View style={[styles.header, { backgroundColor: colors.headerBg }]}>
        <View style={styles.headerLeft}>
          ...
          <View>
            ...
            <Text style={styles.headerSubtitle}>{registeredContacts.length + inviteContacts.length} contacts</Text>
          </View>
        </View>
        <TouchableOpacity
            ...
            <View style={[styles.dropdownMenu, { backgroundColor: colors.background }]}>
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  setLoading(true);
                  // Refresh triggers local cache read
                  loadContacts(searchQuery);
                }}
              >
                <Text style={[styles.dropdownText, { color: colors.textPrimary }]}>Refresh</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.dropdownItem}
                onPress={() => {
              ...
              >
                <Text style={[styles.dropdownText, { color: colors.textPrimary }]}>Contacts</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.dropdownItem}
                onPress={() => {
              ...
              >
                <Text style={[styles.dropdownText, { color: colors.textPrimary }]}>Invite a friend</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={styles.dropdownItem}
                onPress={() => {
              ...
              >
                <Text style={[styles.dropdownText, { color: colors.textPrimary }]}> Help</Text>
              </TouchableOpacity>
            </View>
          </View>
        </TouchableWithoutFeedback>
          ...
          <SectionList
            ...
            ListEmptyComponent={
              <View style={styles.center}>
                ...
                <Text style={{ color: colors.textSecondary, marginTop: 16 }}>No contacts found</Text>
              </View>
            }
          />
        )}
...
const styles = StyleSheet.create({
  ...
  searchBar: { flexDirection: 'row', alignItems: 'center', height: 44, borderRadius: 22, paddingHorizontal: 16 },
  ...
  contactItem: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 16, height: ITEM_HEIGHT },
  avatarContainer: { width: 50, height: 50, borderRadius: 25, justifyContent: 'center', alignItems: 'center', overflow: 'hidden' },
  avatar: { width: '100%', height: '100%' },
  initials: { fontSize: 20, fontWeight: '600' },
  contactInfo: { flex: 1, height: '100%', flexDirection: 'row', alignItems: 'center', marginLeft: 16, borderBottomWidth: StyleSheet.hairlineWidth },
  contactMain: { flex: 1, justifyContent: 'center' },
  contactName: { fontSize: 16, fontWeight: '600', marginBottom: 2 },
  contactPhone: { fontSize: 14 },
  inviteButton: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 16, borderWidth: 1, borderColor: '#00A884' },
