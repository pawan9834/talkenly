...
export default function ImageViewerScreen() {
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.headerContent}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.dateText}>
              {mediaMessages[currentIndex]?.time || ""}
            </Text>
          </View>
          <View style={styles.headerActions}>
            <TouchableOpacity
              style={styles.actionBtn}
              onPress={() => handleOptionPress("Star")}
            >
            ...
            <TouchableOpacity
              style={styles.actionBtn}
              onPress={() => handleOptionPress("Options")}
            >
      ...
      />
      {}
      {mediaMessages[currentIndex]?.text &&
        mediaMessages[currentIndex].text !== "📷 Photo" &&
        mediaMessages[currentIndex].text !== "📽️ Video" && (
          <View
            style={[
              styles.footer,
