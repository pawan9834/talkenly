...
export default function MyStatusDetailsScreen() {
  ...
  const [statusViewsMapper, setStatusViewsMapper] = useState<
    Record<string, { uid: string; viewedAt: any }[]>
  >({});
      ...
      >
        ...
        >
          ...
          <View style={styles.itemInfo}>
            {}
            <TouchableOpacity style={styles.viewCountContainer}>
          ...
          <>
            ...
            <View style={[styles.fabContainer, { bottom: 24 + insets.bottom }]}>
              <TouchableOpacity
                style={[
                  styles.fabSecondary,
                  { backgroundColor: colors.fabSecondary },
                ]}
                activeOpacity={0.8}
              >
                <MaterialIcons
            ...
            >
              ...
              {alertType === "delete" ? (
                <View style={styles.alertActions}>
                  ...
                  >
                    <Text
                      style={[styles.alertBtnText, { color: colors.primary }]}
                    >
                      Cancel
                    </Text>
                  </TouchableOpacity>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <Text
                style={[styles.viewersTitle, { color: colors.textPrimary }]}
              >
                Viewed by
              </Text>
            </View>
                ...
                renderItem={({ item }) => (
                  <View style={styles.viewerItem}>
                    <Image
                      source={{
                        uri:
                          item.photoURL || "https://i.pravatar.cc/150?img=32",
                      }}
